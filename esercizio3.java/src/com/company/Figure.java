...
abstract public class Figure {
    ...
    Figure(double base,double altezza){
        setBase(base);
        setAltezza(altezza);
    }
...
class Trapezio extends Rettangolo{
    ...
    void setBaseM(double BaseM){this.BaseM=BaseM;}
    public double getBaseM(){return this.BaseM;}

    void setlato1(double lato1){this.lato1=lato1;}
    public double getLato1(){return this.lato1;}

    void setlato2(double lato2){this.lato2=lato2;}
    public double getLato2(){return this.lato2;}
    ...
    @Override
    public double perimetro(){return Somma(getBase(),getBaseM(),getLato1(),getLato2()); }
